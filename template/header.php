        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-light">
            <div class="container-fluid">
                <a href="#" class="navbar-brand">
                    <img src="img/kfc.jpg" alt="" height="40" width="40">
                ...
                <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Rekap</a>
                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                                <!-- <li><a href="#" class="dropdown-item"></a></li> -->
                                <li><a href="rekap.php" class="dropdown-item">Register Operasi</a></li>
                        ...
                        <div class="col-sm-6">
                            <figure>
                                <h1 class="blockquote mb-3">
                                    <p>Instalasi Bedah Sentral</p>
                                </h1>
                                <figcaption class="blockquote-footer">
                                    RS Nur Rohmah &nbsp;<cite title="Source Title">IBS</cite>
                                </figcaption>
                            </figure>
